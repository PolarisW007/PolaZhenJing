...
tags: [ai-engineering, context-engineering, llm, rag, anthropic, claude]
...
description: "当你在大模型里塞进越多信息，它反而想得越少。这不是比喻。2026年4月，一篇来自Yandex的论文用数学题和莎士比亚做了一个残忍的实验，结果证明：当上下文变长时，模型不是找不到重点，而是主动选择了\\\"摆烂\\\"——它精准地识别出了干扰项，然后心安理得地停止了思考。这个发现，对整个行业过去两年搭建的工程体系，都是一次釜底抽。"
---
